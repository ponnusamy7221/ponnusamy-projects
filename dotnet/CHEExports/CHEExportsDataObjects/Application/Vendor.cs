...
namespace CHEExportsDataObjects
    {
        [Serializable]
        [DataContract]
        public partial class Vendor : DataObjectBase
        {
            public Vendor()
            {
                TABLE_NAME = "APP_VENDOR";
            }
        ...
        public string vendor_id_column_name_is_primary = "VENDOR_ID";
            public string vendor_name_column_name = "VENDOR_NAME";
            public string vendor_ref_no_column_name = "VENDOR_REF_NO";
