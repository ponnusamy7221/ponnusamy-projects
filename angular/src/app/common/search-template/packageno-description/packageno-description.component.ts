...
@Component({
  selector: 'app-packageno-description',
  standalone: true,
  imports: [
  ...
  templateUrl: './packageno-description.component.html',
  styleUrl: './packageno-description.component.scss',
})
export class PackagenoDescriptionComponent extends Control implements OnInit {
  ...
  autoSearch(event: any) {
    ...
    if (event) {
      ...
      this.api
        .getInStockInvoiceDetailBasedPakgNO(obj, this.options)
        .pipe(
          finalize(() => {
        ...
        .subscribe((success) => {
          this.items = success.lstprotoExportInvoiceDetail;
        });
    }
  }
