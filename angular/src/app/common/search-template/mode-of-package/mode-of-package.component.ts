...
@Component({
  ...
  templateUrl: './mode-of-package.component.html',
  styleUrl: './mode-of-package.component.scss',
})
export class ModeOfPackageComponent extends Control implements OnInit {
